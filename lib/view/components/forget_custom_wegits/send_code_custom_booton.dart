...
class SendCodeCustomBooton extends StatelessWidget {
  final String text;
  final double fontsize;
  final FontWeight fontWeight;
  final Color color;
  final Color textcolor;
  const SendCodeCustomBooton({super.key,required this.text,required this.color,this.fontWeight=FontWeight.w600,this.fontsize=16,this.textcolor=Colors.white});
  @override
